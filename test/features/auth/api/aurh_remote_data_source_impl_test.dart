...
import 'package:fitness_app/features/auth/api/aurh_remote_data_source_impl.dart';
...
void main() {
  ...
  late AurhRemoteDataSourceImpl dataSource;

  setUpAll(() {
    mockApiClient = MockApiClient();
    dataSource = AurhRemoteDataSourceImpl(mockApiClient);
  });
